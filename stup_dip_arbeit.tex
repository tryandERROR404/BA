...
% Titelseite
\title{Verifizierung eines DG Verfahrens mit Hilfe der Method of Manufactured Solutions}

\author{Bachelorarbeit \\
        von \\
        cand.\ aer.\ Sonja Hauber  }

\publishers{durchgef"uhrt am \\
            Institut f"ur Aerodynamik und Gasdynamik \\
            der Universit"at Stuttgart \\[5ex]
...
% Text
\include{stroemunggrundlagen}
\include{dg}
\include{verifizierung}
% Ergebnisse ******************
